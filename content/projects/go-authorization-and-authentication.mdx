...
After storing this secret token in the <File>.env</File> file, we must also do dependency injection on the `apiCfg` by accessing this value in the main function.
